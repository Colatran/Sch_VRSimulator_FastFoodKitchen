...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public partial class ActionBasedController_Custom : XRBaseController
    {
        [SerializeField]
        ...
        void EnableAllDirectActions()
        {
            ...
            m_SecondaryAction.EnableDirectAction();
        }
        ...
        void DisableAllDirectActions()
        {
            ...
            m_SecondaryAction.DisableDirectAction();
        }
        ...
        [SerializeField]
        InputActionProperty m_SecondaryAction;
        public InputActionProperty secondaryAction
        {
            get => m_SecondaryAction;
            set => SetInputActionProperty(ref m_SecondaryAction, value);
        }

        [SerializeField] float m_ButtonPressPoint = 0.75f;
    }
}
